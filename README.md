...
#### Commits shown as Unverified
> Until GitHub supports SSH keys my commits will appear as `Unverified`. If verification is necessary, you may verify them manually.
>
